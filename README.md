# OpenLMIS Eswatini CMIS UI Module
This repository is the UI for the [OpenLMIS Eswatini CMIS Service.](https://github.com/clintonhealthaccess/eswatini-OpenLMIS-CMIS-UI)
...
1. Fork/clone this repository from GitHub.
 ...
 ```shell
> git clone https://github.com/clintonhealthaccess/eswatini-OpenLMIS-CMIS-UI.git
> cd openlmis-cmis-ui/
 ```
