...
(function () {
    ...
    angular
        ...
        .service('CmisDispenseServicev1', CmisDispenseServicev1);

    CmisDispenseServicev1.$inject = [
        '$q', 'CmisIntervalService', 'INTERVAL', 'CmisRequestService'
    ];

    function CmisDispenseServicev1($q, CmisIntervalService, INTERVAL, CmisRequestService) {
